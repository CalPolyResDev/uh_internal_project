...
from resnet_internal.apps.dailyduties.tasks import update_slack_voicemail, update_slack_email  # noqa
from resnet_internal.apps.portmap.tasks import update_slack_network_status  # noqa
