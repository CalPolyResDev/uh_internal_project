        ...
        if column == 'downstream_devices':
            ...
            if device_is_down(row.upstream_device):
                ...
                if(getattr(row, column)):
                    icon_name = "deactivate"
                    icon_url = static("images/icons/disconnect.png")
                else:
                    icon_name = "activate"
                    icon_url = static("images/icons/connect.ico")
                return self.render_action_column(row=row, column=column, function_name="confirm_status_change", icon_name=icon_name, icon_url=icon_url)
        else:
