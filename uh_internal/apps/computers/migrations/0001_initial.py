    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_id', models.CharField(blank=True,
                                                 default=None,
                                                 max_length=50,
                                                 null=True,
                                                 unique=True,
                                                 verbose_name='Cal Poly Property ID')),
                ...
                ('department', models.ForeignKey(on_delete=CASCADE,
                                                 to='core.Department',
                                                 verbose_name='Department')),
                ('sub_department', models.ForeignKey(on_delete=CASCADE,
                                                     to='core.SubDepartment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sr_number', models.IntegerField(db_column='ticket_id',
                                                  null=True,
