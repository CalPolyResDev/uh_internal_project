...
urlpatterns += [
    ...
    url(r'^daily_duties/email/get_mailbox_summary/(?P<mailbox_name>.+)/(?P<search_string>.+)/(?P<message_range_start>[0-9]+)/(?P<message_range_end>[0-9]+)/$', login_required(technician_access(get_mailbox_summary)), name='email_get_mailbox_summary_range'),
