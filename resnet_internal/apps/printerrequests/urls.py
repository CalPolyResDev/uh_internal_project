...
urlpatterns = [
    ...
    url(r'^toner_request/', login_required(printer_request_create_access(RequestTonerView.as_view())), name='toner_request'),
    url(r'^parts_request/', login_required(printer_request_create_access(RequestPartsView.as_view())), name='parts_request'),
