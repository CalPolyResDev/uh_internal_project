...
class PrinterRequestsRouter(object):
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if (obj1._meta.app_label == self.APP_NAME or obj2._meta.app_label == self.APP_NAME) and obj1._meta.model_name != self.EXCLUDED_MODEL and obj2._meta.model_name != self.EXCLUDED_MODEL:
            return True
        return None
    ...
    def allow_migrate(self, db, app_label, model=None, **hints):
        ...
        if app_label == self.APP_NAME and model._meta.model_name != self.EXCLUDED_MODEL:
            return False
        return None
